...
export const projects: Project[] = [
  {
    ...
    galleryImages: [
      { src: "/images/projects/centro-cultural-la-ceiba/15.jpg", alt: "Panoramic elevation render", width: 2238, height: 262, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/09.jpg", alt: "Aerial axonometric render with landscape", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/06.jpg", alt: "Axonometric massing diagram", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/07.jpg", alt: "Annotated site plan with landscape", width: 792, height: 612, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/03.jpg", alt: "Detailed floor plan", width: 1494, height: 809, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/01.jpg", alt: "Front elevation section", width: 826, height: 223, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/02.jpg", alt: "Exterior elevation in desert landscape", width: 816, height: 243, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/08.jpg", alt: "Exploded axonometric material layers", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/10.jpg", alt: "Contour topography diagram", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/05.jpg", alt: "Interior render with undulating ceiling", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/11.jpg", alt: "Interior render with vaulted spaces and oculi", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/12.jpg", alt: "Fabric form study model", width: 792, height: 612, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/04.jpg", alt: "Wall section construction details", width: 229, height: 563, layout: "half" },
      { src: "/images/projects/centro-cultural-la-ceiba/13.jpg", alt: "Wall section detail with annotations", width: 624, height: 327, layout: "full" },
      { src: "/images/projects/centro-cultural-la-ceiba/14.jpg", alt: "Foundation section detail with annotations", width: 677, height: 300, layout: "full" },
    ],
    featured: true,
  },
  {
